...
export const DAYLIGHT_SOFT = [
  "radial-gradient(60% 48% at 4% -4%, rgba(150,190,235,.12), transparent 62%)",
  "radial-gradient(70% 40% at 58% -6%, rgba(170,205,240,.09), transparent 64%)",
  "radial-gradient(44% 32% at 100% 46%, rgba(240,198,145,.10), transparent 62%)",
  "radial-gradient(76% 46% at 78% 106%, rgba(160,182,215,.10), transparent 66%)",
].join(",");
