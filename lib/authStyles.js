...
/* Same directional daylight as the app: warm high-left, cool low-right, very
   ...
   It was duplicated there once at lower alphas, then dimmed further while
   chasing a background problem — which made things worse, because these
   gradients are where the blue and the sunlight come from. One definition
   now, so the app and the sign-in page can't drift apart again. */
...
export const S = {
  wrap: {
    minHeight: "100vh",
    // Pale oak, warmer than the app's own surface: these are the pages a
